...
function get_arch() {
    printf "${yellow}[*] Checking device architecture ..."
...
function check_dependencies() {
    ...
    ## Workaround for termux-app issue #1283 (https://github.com/termux/termux-app/iss>
...
function start-kex() {
    ...
    export MOZ_FAKE_NO_SANDBOX=1; export HOME=\${HOME}; export USER=\${USR}; LD_PRELOA>
    starting_kex=1
    return 0
...
function print_banner() {
    ...
    printf "${green}########################################################\n"
    printf "${green}##                                                     ##\n"
    printf "${green}##   888888888888888888   888888888888   88888888      ##\n"
    printf "${green}##   88      88      88   88        88   88     88     ##\n"
    printf "${green}##   88      88      88   88        88   88      88    ##\n"
    printf "${green}##   88      88      88   88        88   88       88   ##\n"
    printf "${green}##   88      88      88   88        88   88       88   ##\n"
    printf "${green}##   88      88      88   88        88   88      88    ##\n"
    printf "${green}##   88      88      88   88        88   88     88     ##\n"
    printf "${green}##   88      88      88   888888888888   88888888      ##\n"
    printf "${green}##                                                     ##\n"
...
print_banner
printf "${red}[=] Kali NetHunter for Termux installed successfully${reset}\n\n"
printf "${red}[+] To start Kali NetHunter, type:${reset}\n"
printf "${red}[+] nethunter             # To start NetHunter CLI${reset}\n"
printf "${red}[+] nethunter kex passwd  # To set the KeX password${reset}\n"
printf "${red}[+] nethunter kex &       # To start NetHunter GUI${reset}\n"
printf "${red}[+] nethunter kex stop    # To stop NetHunter GUI${reset}\n"
#printf "${red}[+] nethunter kex <command> # Run command in NetHunter env${reset}\n"
printf "${red}[+] nethunter -r          # To run NetHunter as root${reset}\n"

#printf "${red}[+] nethunter -r kex passwd  # To set the KeX password for root${reset}\n"
#printf "${red}[+] nethunter kex &       # To start NetHunter GUI as root${reset}\n"
#printf "${red}[+] nethunter kex stop    # To stop NetHunter GUI root session${reset}\n"
#printf "${red}[+] nethunter -r kex kill # To stop all NetHunter GUI sessions${reset}\n"
#printf "${red}[+] nethunter -r kex <command> # Run command in NetHunter env as root${reset}\n"
printf "${red}[+] nh                    # Shortcut for nethunter${reset}\n\n"
